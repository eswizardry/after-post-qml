...
Popup {
    ...
    property int timePickerWidth: isLandscape? safeWidth * 0.85 : safeWidth * 0.80
    property int timePickerHeight: isLandscape? safeHeight * 0.90 : safeHeight * 0.85
    x: (safeWidth - timePickerWidth) / 2
    ...
    y: isLandscape? (safeHeight - timePickerHeight) / 2 - 48 : (safeHeight - timePickerHeight) / 2 - 24
